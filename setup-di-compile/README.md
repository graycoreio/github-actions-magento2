...
jobs:
  ...
  compile:
    ...
    steps:
      ...
      - uses: graycoreio/github-actions-magento8/cache-magento@v7 # x-release-please-major

      - run: composer install
        env:
          COMPOSER_AUTH: ${{ secrets.COMPOSER_AUTH }}

      - uses: graycoreio/github-actions-magento8/setup-di-compile@v7 # x-release-please-major
        with:
