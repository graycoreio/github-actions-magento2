...
jobs:
  ...
  compile:
    ...
    steps:
      ...
      - uses: graycoreio/github-actions-magento2/cache-magento@v8.9.0 # x-release-please-version

      - run: composer install
        env:
          COMPOSER_AUTH: ${{ secrets.COMPOSER_AUTH }}

      - uses: graycoreio/github-actions-magento2/setup-di-compile@v8.9.0 # x-release-please-version
        with:
